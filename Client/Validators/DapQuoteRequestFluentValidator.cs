...
public class DapQuoteRequestFluentValidator : AbstractValidator<QuoteRequest>
{
    public DapQuoteRequestFluentValidator()
    {
        When(x => x.ValidationEnabled, () =>
        {
            _ = RuleFor(x => x.ToPincode)
                ...
                .Length(5, 10).WithMessage("Please enter an valid Pincode");
